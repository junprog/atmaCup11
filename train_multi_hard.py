...
from engine.multi_task_trainer import MultiTaskTrainer_hard
...
def parse_args():
    ...
    parser.add_argument('--cv-weight-dir', type=str, default='',
                        help='cv pre-train model path')
...
if __name__ == '__main__':
    ...
    trainer = MultiTaskTrainer_hard(args)
    trainer.setup()
    trainer.train()
